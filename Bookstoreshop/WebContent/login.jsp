...
<a href="http://jigsaw.w3.org/css-validator/check/referer"><img style="border:0;width:88px;height:31px"  src="http://jigsaw.w3.org/css-validator/images/vcss-blue" alt="Valid CSS!" vspace="8" border="0" /></a>
        ...
        <div id="templatemo_content_right">
        	<form action="UserServlet" method="post" height="400px">
        	<fieldset>
        	<legend><h1>Login details:</h1></legend>
        	EmailId1:&emsp;<input type="text" name="emailid"><br><br></br></br>
Password:<input type="text" name="password1"><br><br><br></br></br>
<input type="submit" name="action" value="Login"><br><br><br></br></br>
